...
<section class="page_content_parent_section" style="padding-top: 0px; margin-top: -2.25%;">
    ...
    <!-- header -->
        ...
        <!-- /Main Slider Section -->
        <section class="slider-area cursor-light" style="margin-top: 0px;">
            <div class="bg-overlay"></div>
            <div class="container position-relative">
                <div class="inner-bg-overlay"></div>
                <div class="row">
                    <div class="slider-detail col-12 col-lg-6 text-center text-lg-left wow fadeInLeft slick-initialized slick-slider" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInLeft;"><div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 3780px; transform: translate3d(-540px, 0px, 0px);"><div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                                ...
                                <a href="#about-sec" class="btn anim-btn rounded-pill scroll" tabindex="-1">LEARN MORE
                                    <span></span><span></span><span></span><span></span>
                                </a>
                            </div>
                        </div></div></div><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                                <h4 class="slide-heading">
                                    WHO WE ARE <span> </span></h4>
                                <p class="slide-text">We are an award-winning digital agency that is passionate, dedicated, and committed toward delivering excellent results. We take pride in our outstanding communication skills, and make it a point to exceed our clients’ expectations.
                                    ...
                                    We realize that the online world continues to evolve, which is why we take time to keep up with the latest in trends and technologies.</p>
                                <a href="#about-sec" class="btn anim-btn rounded-pill scroll" tabindex="0">LEARN MORE
                                    <span></span><span></span><span></span><span></span>
                                </a>
                            </div>
                        </div></div></div><div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                        ...
                        </div></div></div><div class="slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                                <h4 class="slide-heading">MODERN <span>ARCHITECT WORKS</span></h4>
                                <p class="slide-text">Lorem Ipsum has been the industry’s standard dummy.  Lorem Ipsum has been the industry’s standard dummy. Lorem ipsum is simply dummy text of the printing and typesetting.</p>
                                <a href="#about-sec" class="btn anim-btn rounded-pill scroll" tabindex="-1">LEARN MORE
                        ...
                        </div></div></div><div class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                        ...
                        </div></div></div><div class="slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                                <h4 class="slide-heading">MODREN <span>CREATIVE STUDIO</span></h4>
                                <p class="slide-text">Lorem Ipsum has been the industry’s standard dummy. Lorem ipsum is simply dummy text of the printing and typesetting. Lorem Ipsum has been the industry’s standard dummy.</p>
                                <a href="#about-sec" class="btn anim-btn rounded-pill scroll" tabindex="-1">LEARN MORE
                        ...
                        </div></div></div><div class="slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="slider-slide" style="width: 100%; display: inline-block;">
                            <div class="slider-inner-content">
                                <h4 class="slide-heading">MODERN <span>ARCHITECT WORKS</span></h4>
                                <p class="slide-text">Lorem Ipsum has been the industry’s standard dummy.  Lorem Ipsum has been the industry’s standard dummy. Lorem ipsum is simply dummy text of the printing and typesetting.</p>
                                <a href="#about-sec" class="btn anim-btn rounded-pill scroll" tabindex="-1">LEARN MORE
                    ...
                    <div class="slider-img col-12 col-lg-6 wow fadeInRight slick-initialized slick-slider slick-vertical" data-wow-delay=".8s" data-depth="0.1" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInRight; transform: translate3d(-12.175px, -9px, 0px);"><div class="slick-list draggable" style="height: 407.25px;"><div class="slick-track" style="opacity: 1; height: 2851px; transform: translate3d(0px, -407px, 0px);"><div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide3.jpg">
                        </div></div></div><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide1.jpg">
                        </div></div></div><div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide2.jpg">
                        </div></div></div><div class="slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide3.jpg">
                        </div></div></div><div class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide1.jpg">
                        </div></div></div><div class="slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide2.jpg">
                        </div></div></div><div class="slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 540px;"><div><div class="img-slide" style="width: 100%; display: inline-block;">
                            <img src="architect-studio/img/slide3.jpg">
                        </div></div></div></div></div></div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6 services-area padding-top padding-bottom">
                        ...
                        <div class="row no-gutters wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                    ...
                    <div class="col-12 col-lg-6 about-area padding-top padding-bottom text-center text-lg-left">
                        <div class="about-content wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                            <div class="about-inner-content">
                                <h4 class="heading">WHY <span class="text-yellow">CHOOSE US</span></h4>
                                <p class="text">
            ...
            <div class="container">
                <div class="row inner-team-sec padding-top padding-bottom">
                    <div class="col-12 col-lg-4 text-center text-lg-left">
                        <div class="team-detail wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                            <h4 class="heading">WE HAVE <span>AMAZING TEAM</span></h4>
                            <p class="text">
                                We help convert your online business dreams into reality.

                            </p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-8">
                        <div class="team-area wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                            <div class="row no-gutters team-carousel owl-carousel owl-theme owl-loaded owl-drag">
                                
                                
                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-614px, 0px, 0px); transition: all 0.5s ease 0s; width: 1842px;"><div class="owl-item cloned" style="width: 277px; margin-right: 30px;"><div class="item text-center">
                                    <div class="team-box">
                                ...
                                </div></div><div class="owl-item cloned" style="width: 277px; margin-right: 30px;"><div class="item text-center">
                                    <div class="team-box">
                                        <div class="img-holder position-relative">
                                ...
                                </div></div><div class="owl-item active" style="width: 277px; margin-right: 30px;"><div class="item text-center">
                                    <div class="team-box">
                                        <div class="img-holder position-relative">
                                            <img src="architect-studio/img/team1.jpg">
                                            <div class="overlay d-flex justify-content-center align-items-center">
